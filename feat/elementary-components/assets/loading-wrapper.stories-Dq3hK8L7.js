import{i as w,a as f,x as h}from"./iframe-BGvQkpiq.js";import{n as a,t as m}from"./property-D6F16MwZ.js";import{r as u}from"./state-D2OacseK.js";import"./loading-indicator-B9RK7BHS.js";import"./text-button-fP_TEJxN.js";var s=Object.defineProperty,y=Object.getOwnPropertyDescriptor,x=(o,t,r)=>t in o?s(o,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):o[t]=r,n=(o,t,r,p)=>{for(var i=p>1?void 0:p?y(t,r):t,l=o.length-1,c;l>=0;l--)(c=o[l])&&(i=(p?c(t,r,i):c(i))||i);return p&&i&&s(t,r,i),i},v=(o,t,r)=>x(o,t+"",r);class b{instance=null;findGlobalLoading(){if(this.instance)return this.instance;let t=document.querySelector("loading-wrapper");return t?(this.instance=t,t):null}startLoading(){const t=this.findGlobalLoading();t&&t.setVisible(!0)}endLoading(){const t=this.findGlobalLoading();t&&t.setVisible(!1)}}const g=new b;let e=class extends f{setVisible(o){this.visible=o}updateStyleVariable(o,t,r){const p=this[o]??r;this.style.setProperty(t,p)}updated(o){const t=(r,p,i)=>o.has(r)&&this.updateStyleVariable(r,p,i);t("compHeight","--loading-wrapper-comp-height","100%"),t("compWidth","--loading-wrapper-comp-width","100%"),t("compZindex","--loading-wrapper-z-index","1000000000"),t("wrapperHeight","--loading-wrapper-height","100%"),t("wrapperWidth","--loading-wrapper-width","100%"),t("wrapperOverflowX","--loading-wrapper-overflow-x","hidden"),t("wrapperOverflowY","--loading-wrapper-overflow-y","hidden"),t("loadContHeight","--loading-wrapper-container-height","fit-content"),t("loadContWidth","--loading-wrapper-container-width","fit-content"),t("loadContTop","--loading-wrapper-container-top","20px"),t("loadContBottom","--loading-wrapper-container-bottom","auto"),t("loadContLeft","--loading-wrapper-container-left","50%"),t("loadContRight","--loading-wrapper-container-right","50%"),t("contentHeight","--loading-wrapper-content-height","100%"),t("contentWidth","--loading-wrapper-content-width","100%"),t("contentZindex","--loading-wrapper-content-z-index","1")}render(){return h`
