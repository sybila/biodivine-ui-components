import{i as g,a as y,x as p}from"./iframe-elR7wou-.js";import{n,t as v}from"./property-B2V1JLjv.js";var h=Object.defineProperty,f=Object.getOwnPropertyDescriptor,m=(t,o,r)=>o in t?h(t,o,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[o]=r,i=(t,o,r,a)=>{for(var l=a>1?void 0:a?f(o,r):o,s=t.length-1,u;s>=0;s--)(u=t[s])&&(l=(a?u(o,r,l):u(l))||l);return a&&l&&h(o,r,l),l},d=(t,o,r)=>m(t,typeof o!="symbol"?o+"":o,r);let e=class extends y{changeHandler(t){this.handleChange&&this.handleChange(t.target.value)}blurHandler(t){this.handleBlur&&this.handleBlur(t.target.value)}keyUpHandler(t){this.handleKeyUp&&this.handleKeyUp(t.target.value)}updateStyleVariable(t,o,r){const a=this[t]??r;this.style.setProperty(o,a)}updated(t){const o=(r,a,l)=>t.has(r)&&this.updateStyleVariable(r,a,l);o("compHeight","--invisible-input-comp-height","28px"),o("compWidth","--invisible-input-comp-width","300px"),o("contOverflowX","--invisible-input-cont-overflow-x","auto"),o("contOverflowY","--invisible-input-cont-overflow-y","auto"),o("contPadX","--invisible-input-cont-padx","0"),o("contPadY","--invisible-input-cont-pady","0"),o("contBorderRadius","--invisible-input-border-radius","4px"),o("contBgColor","--invisible-input-cont-bg-color","transparent"),o("contFocusBgColor","--invisible-input-cont-focus-bg-color","transparent"),o("contErrorBgColor","--invisible-input-cont-error-bg-color","rgba(200, 40, 40, 0.4)"),o("textLineHeight","--invisible-input-text-line-height","27px"),o("fontFamily","--invisible-input-font-family","'FiraMono', monospace"),o("fontWeight","--invisible-input-font-weight","normal"),o("fontSize","--invisible-input-font-size","20px"),o("textColor","--invisible-input-text-color","black"),o("textAlign","--invisible-input-text-align","start"),o("focusFontFamily","--invisible-input-focus-font-family","'FiraMonoBold', monospace"),o("focusFontWeight","--invisible-input-focus-font-weight","bold"),o("placeholderColor","--invisible-input-placeholder-color","grey"),o("placeholderFontStyle","--invisible-input-placeholder-font-style","normal"),o("placeholderFontFamily","--invisible-input-placeholder-font-family","'FiraMono', monospace")}render(){const t=this.multiLine?"multiline":"",o=this.value??"",r=this.error?"error":"";return p`<div
      id="container"
      class="${t} ${r}"
      part="container"
    >
      ...
      <img
        id="hover-icon"
        src="${this.hoverIconSrc??e.defaultIconSrc}"
        alt="hover icon"
        part="hover-icon"
      />
    </div>`}};d(e,"styles",g`
  ...
  `);d(e,"defaultIconSrc","data:image/svg+xml;base64,");i([n({type:String})],e.prototype,"compHeight",2);i([n({type:String})],e.prototype,"compWidth",2);i([n({type:String})],e.prototype,"contBgColor",2);i([n({type:String})],e.prototype,"contFocusBgColor",2);i([n({type:String})],e.prototype,"contErrorBgColor",2);i([n({type:String})],e.prototype,"contPadX",2);i([n({type:String})],e.prototype,"contPadY",2);i([n({type:String})],e.prototype,"contBorderRadius",2);i([n({type:String})],e.prototype,"contOverflowX",2);i([n({type:String})],e.prototype,"contOverflowY",2);i([n({type:String})],e.prototype,"textLineHeight",2);i([n({type:String})],e.prototype,"fontFamily",2);i([n({type:String})],e.prototype,"fontWeight",2);i([n({type:String})],e.prototype,"fontSize",2);i([n({type:String})],e.prototype,"textColor",2);i([n({type:String})],e.prototype,"textAlign",2);i([n({type:String})],e.prototype,"focusFontFamily",2);i([n({type:String})],e.prototype,"focusFontWeight",2);i([n({type:String})],e.prototype,"placeholderColor",2);i([n({type:String})],e.prototype,"placeholderFontStyle",2);i([n({type:String})],e.prototype,"placeholderFontFamily",2);i([n({type:Boolean})],e.prototype,"multiLine",2);i([n({type:String})],e.prototype,"hoverIconSrc",2);i([n({type:String})],e.prototype,"hoverIconHeight",2);i([n({type:String})],e.prototype,"hoverIconWidth",2);i([n({type:String})],e.prototype,"value",2);i([n({type:Boolean})],e.prototype,"error",2);i([n({type:String})],e.prototype,"placeholder",2);i([n({type:Function})],e.prototype,"handleChange",2);i([n({type:Function})],e.prototype,"handleBlur",2);i([n({type:Function})],e.prototype,"handleKeyUp",2);e=i([v("invisible-input")],e);const F={title:"Components/Text/Invisible Input",tags:["autodocs"],parameters:{docs:{description:{component:`
### '<invisible-input>'
...
`;c.args={compHeight:"28px",compWidth:"300px",contBgColor:"transparent",contFocusBgColor:"transparent",contErrorBgColor:"rgba(200, 40, 40, 0.4)",contPadX:"8px",contPadY:"6px",contBorderRadius:"6px",contOverflowX:"auto",contOverflowY:"auto",textLineHeight:"27px",fontFamily:"'FiraMono', monospace",fontWeight:"normal",fontSize:"20px",textColor:"black",textAlign:"start",focusFontFamily:"'FiraMonoBold', monospace",focusFontWeight:"bold",placeholderColor:"gray",placeholderFontStyle:"normal",placeholderFontFamily:"'FiraMono', monospace",multiLine:!1,hoverIconSrc:void 0,hoverIconHeight:"24px",hoverIconWidth:"24px",value:"",placeholder:"Enter text here...",error:!1,handleBlur:t=>console.log(`Blur: ${t}`),handleChange:t=>console.log(`Change: ${t}`),handleKeyUp:t=>console.log(`KeyUp: ${t}`)};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`args => html\`
  ...
  ></invisible-input>
\``,...c.parameters?.docs?.source}}};const w=["Default"];export{c as Default,w as __namedExportsOrder,F as default};
