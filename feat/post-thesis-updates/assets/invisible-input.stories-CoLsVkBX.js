import{i as g,a as y,x as p}from"./iframe-xE6n3bsN.js";import{n,t as v}from"./property-BiGtfe2A.js";var d=Object.defineProperty,m=Object.getOwnPropertyDescriptor,f=(t,e,r)=>e in t?d(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,i=(t,e,r,l)=>{for(var a=l>1?void 0:l?m(e,r):e,s=t.length-1,u;s>=0;s--)(u=t[s])&&(a=(l?u(e,r,a):u(a))||a);return l&&a&&d(e,r,a),a},h=(t,e,r)=>f(t,typeof e!="symbol"?e+"":e,r);let o=class extends y{changeHandler(t){this.handleChange&&this.handleChange(t.target.value)}blurHandler(t){this.handleBlur&&this.handleBlur(t.target.value)}keyUpHandler(t){this.handleKeyUp&&this.handleKeyUp(t.target.value)}updateStyleVariable(t,e,r){const l=this[t]??r;this.style.setProperty(e,l)}async focus(){await this.updateComplete,this.renderRoot?.querySelector(this.multiLine?"#multiline-text-input":"#text-input")?.focus()}updated(t){const e=(r,l,a)=>t.has(r)&&this.updateStyleVariable(r,l,a);e("compHeight","--invisible-input-comp-height","28px"),e("compWidth","--invisible-input-comp-width","300px"),e("contOverflowX","--invisible-input-cont-overflow-x","auto"),e("contOverflowY","--invisible-input-cont-overflow-y","auto"),e("contPadX","--invisible-input-cont-padx","0"),e("contPadY","--invisible-input-cont-pady","0"),e("contBorderRadius","--invisible-input-border-radius","4px"),e("contBgColor","--invisible-input-cont-bg-color","transparent"),e("contFocusBgColor","--invisible-input-cont-focus-bg-color","transparent"),e("contErrorBgColor","--invisible-input-cont-error-bg-color","rgba(200, 40, 40, 0.4)"),e("textLineHeight","--invisible-input-text-line-height","27px"),e("fontFamily","--invisible-input-font-family","'FiraMono', monospace"),e("fontWeight","--invisible-input-font-weight","normal"),e("fontSize","--invisible-input-font-size","20px"),e("textColor","--invisible-input-text-color","black"),e("textAlign","--invisible-input-text-align","start"),e("focusFontFamily","--invisible-input-focus-font-family","'FiraMonoBold', monospace"),e("focusFontWeight","--invisible-input-focus-font-weight","bold"),e("placeholderColor","--invisible-input-placeholder-color","grey"),e("placeholderFontStyle","--invisible-input-placeholder-font-style","normal"),e("placeholderFontFamily","--invisible-input-placeholder-font-family","'FiraMono', monospace")}onSubmit(t){this.handleSubmit&&t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),this.handleSubmit(t.target.value))}render(){const t=this.multiLine?"multiline":"",e=this.value??"",r=this.error?"error":"",l=this.editable===!1?"not-editable":"";return p`<div
      id="container"
      class="${t} ${r} ${l}"
      part="container"
    >
  ...
  `);h(o,"defaultIconSrc","data:image/svg+xml;base64,");i([n({type:String})],o.prototype,"compHeight",2);i([n({type:String})],o.prototype,"compWidth",2);i([n({type:String})],o.prototype,"contBgColor",2);i([n({type:String})],o.prototype,"contFocusBgColor",2);i([n({type:String})],o.prototype,"contErrorBgColor",2);i([n({type:String})],o.prototype,"contPadX",2);i([n({type:String})],o.prototype,"contPadY",2);i([n({type:String})],o.prototype,"contBorderRadius",2);i([n({type:String})],o.prototype,"contOverflowX",2);i([n({type:String})],o.prototype,"contOverflowY",2);i([n({type:String})],o.prototype,"textLineHeight",2);i([n({type:String})],o.prototype,"fontFamily",2);i([n({type:String})],o.prototype,"fontWeight",2);i([n({type:String})],o.prototype,"fontSize",2);i([n({type:String})],o.prototype,"textColor",2);i([n({type:String})],o.prototype,"textAlign",2);i([n({type:String})],o.prototype,"focusFontFamily",2);i([n({type:String})],o.prototype,"focusFontWeight",2);i([n({type:String})],o.prototype,"placeholderColor",2);i([n({type:String})],o.prototype,"placeholderFontStyle",2);i([n({type:String})],o.prototype,"placeholderFontFamily",2);i([n({type:Boolean})],o.prototype,"multiLine",2);i([n({type:String})],o.prototype,"hoverIconSrc",2);i([n({type:String})],o.prototype,"hoverIconHeight",2);i([n({type:String})],o.prototype,"hoverIconWidth",2);i([n({type:String})],o.prototype,"value",2);i([n({type:Boolean})],o.prototype,"error",2);i([n({type:Boolean})],o.prototype,"editable",2);i([n({type:String})],o.prototype,"placeholder",2);i([n({type:Function})],o.prototype,"handleSubmit",2);i([n({type:Function})],o.prototype,"handleChange",2);i([n({type:Function})],o.prototype,"handleBlur",2);i([n({type:Function})],o.prototype,"handleKeyUp",2);o=i([v("invisible-input")],o);const F={title:"Components/Text/Invisible Input",tags:["autodocs"],parameters:{docs:{description:{component:`
### '<invisible-input>'
...
`;c.args={compHeight:"28px",compWidth:"300px",contBgColor:"transparent",contFocusBgColor:"transparent",contErrorBgColor:"rgba(200, 40, 40, 0.4)",contPadX:"8px",contPadY:"6px",contBorderRadius:"6px",contOverflowX:"auto",contOverflowY:"auto",textLineHeight:"27px",fontFamily:"'FiraMono', monospace",fontWeight:"normal",fontSize:"20px",textColor:"black",textAlign:"start",focusFontFamily:"'FiraMonoBold', monospace",focusFontWeight:"bold",placeholderColor:"gray",placeholderFontStyle:"normal",placeholderFontFamily:"'FiraMono', monospace",multiLine:!1,editable:!0,hoverIconSrc:void 0,hoverIconHeight:"24px",hoverIconWidth:"24px",value:"",placeholder:"Enter text here...",error:!1,handleSubmit:t=>console.log(`Submit: ${t}`),handleBlur:t=>console.log(`Blur: ${t}`),handleChange:t=>console.log(`Change: ${t}`),handleKeyUp:t=>console.log(`KeyUp: ${t}`)};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`args => html\`
  ...
  ></invisible-input>
\``,...c.parameters?.docs?.source}}};const S=["Default"];export{c as Default,S as __namedExportsOrder,F as default};
