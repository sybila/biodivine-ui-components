import{i as x,a as g,x as p}from"./iframe-DhGavQM0.js";import{n,t as m}from"./property-DttxfjMj.js";var u=Object.defineProperty,v=Object.getOwnPropertyDescriptor,y=(t,e,r)=>e in t?u(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,o=(t,e,r,a)=>{for(var l=a>1?void 0:a?v(e,r):e,h=t.length-1,s;h>=0;h--)(s=t[h])&&(l=(a?s(e,r,l):s(l))||l);return a&&l&&u(e,r,l),l},d=(t,e,r)=>y(t,typeof e!="symbol"?e+"":e,r);let i=class extends g{changeHandler(t){this.handleChange&&this.handleChange(t.target.value)}blurHandler(t){this.handleBlur&&this.handleBlur(t.target.value)}keyUpHandler(t){this.handleKeyUp&&this.handleKeyUp(t.target.value)}updateStyleVariable(t,e,r){const a=this[t]??r;this.style.setProperty(e,a)}updated(t){const e=(r,a,l)=>t.has(r)&&this.updateStyleVariable(r,a,l);e("contMinHeight","--invisible-input-cont-min-height","28px"),e("contMinWidth","--invisible-input-cont-min-width","400px"),e("contMaxHeight","--invisible-input-cont-max-height","28px"),e("contMaxWidth","--invisible-input-cont-max-width","400px"),e("contOverflowX","--invisible-input-cont-overflow-x","auto"),e("contOverflowY","--invisible-input-cont-overflow-y","auto"),e("contPadX","--invisible-input-cont-padx","0"),e("contPadY","--invisible-input-cont-pady","0"),e("contBorderRadius","--invisible-input-border-radius","4px"),e("contFocusBgColor","--invisible-input-cont-focus-bg-color","transparent"),e("contErrorBgColor","--invisible-input-cont-error-bg-color","rgba(200, 40, 40, 0.4)"),e("textBoxMinHeight","--invisible-input-textbox-min-height","28px"),e("textBoxMinWidth","--invisible-input-textbox-min-width","400px"),e("textBoxMaxHeight","--invisible-input-textbox-max-height","28px"),e("textBoxMaxWidth","--invisible-input-textbox-max-width","400px"),e("textLineHeight","--invisible-input-text-line-height","27px"),e("fontFamily","--invisible-input-font-family","'FiraMono', monospace"),e("fontWeight","--invisible-input-font-weight","normal"),e("fontSize","--invisible-input-font-size","20px"),e("textColor","--invisible-input-text-color","black"),e("textAlign","--invisible-input-text-align","start"),e("focusFontFamily","--invisible-input-focus-font-family","'FiraMonoBold', monospace"),e("focusFontWeight","--invisible-input-focus-font-weight","bold"),e("placeholderColor","--invisible-input-placeholder-color","grey"),e("placeholderFontStyle","--invisible-input-placeholder-font-style","normal"),e("placeholderFontFamily","--invisible-input-placeholder-font-family","'FiraMono', monospace")}render(){const t=this.multiLine?"multiline":"",e=this.value??"",r=this.error?"error":"";return p`<div
      id="container"
      class="${t} ${r}"
      part="container"
    >
...
`;c.args={contMinHeight:"28px",contMinWidth:"400px",contMaxHeight:"28px",contMaxWidth:"400px",contPadX:"8px",contPadY:"6px",contBorderRadius:"6px",contOverflowX:"auto",contOverflowY:"auto",textBoxMinHeight:"28px",textBoxMinWidth:"400px",textBoxMaxHeight:"28px",textBoxMaxWidth:"400px",textLineHeight:"27px",fontFamily:"'FiraMono', monospace",fontWeight:"normal",fontSize:"20px",textColor:"black",textAlign:"start",focusFontFamily:"'FiraMonoBold', monospace",focusFontWeight:"bold",placeholderColor:"gray",placeholderFontStyle:"normal",placeholderFontFamily:"'FiraMono', monospace",contFocusBgColor:"transparent",contErrorBgColor:"rgba(200, 40, 40, 0.4)",multiLine:!1,hoverIconHeight:"24px",hoverIconWidth:"24px",value:"",placeholder:"Enter text here...",error:!1,handleBlur:t=>console.log(`Blur: ${t}`),handleChange:t=>console.log(`Change: ${t}`),handleKeyUp:t=>console.log(`KeyUp: ${t}`)};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`args => html\`
  ...
  ></invisible-input>
\``,...c.parameters?.docs?.source}}};const w=["Default"];export{c as Default,w as __namedExportsOrder,M as default};
