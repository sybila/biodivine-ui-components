import{i as f,a as u,x as p}from"./iframe-rZNKRr2j.js";import{n as r,t as y}from"./property-BsoqjfFA.js";var m=Object.defineProperty,h=Object.getOwnPropertyDescriptor,d=(t,e,l)=>e in t?m(t,e,{enumerable:!0,configurable:!0,writable:!0,value:l}):t[e]=l,n=(t,e,l,i)=>{for(var a=i>1?void 0:i?h(e,l):e,c=t.length-1,x;c>=0;c--)(x=t[c])&&(a=(i?x(e,l,a):x(a))||a);return i&&a&&m(e,l,a),a},g=(t,e,l)=>d(t,e+"",l);let o=class extends u{updateStyleVariable(t,e,l){const i=this[t]??l;this.style.setProperty(e,i)}updated(t){const e=(l,i,a)=>t.has(l)&&this.updateStyleVariable(l,i,a);e("compHeight","--non-scrollable-text-comp-height","fit-content"),e("compWidth","--non-scrollable-text-comp-width","200px"),e("textColor","--non-scrollable-text-color","black"),e("textJustify","--non-scrollable-text-justify","start"),e("textAlign","--non-scrollable-text-align","center"),e("textShadow","--non-scrollable-text-shadow","none"),e("textFontSize","--non-scrollable-text-font-size","16px"),e("textFontWeight","--non-scrollable-text-font-weight","normal"),e("textFontFamily","--non-scrollable-text-font-family","'Helvetica', 'Arial', sans-serif"),e("textOverflow","--non-scrollable-text-overflow","ellipsis"),e("userSelect","--non-scrollable-text-user-select","none")}render(){return p`${this.text}`}};g(o,"styles",f`
    :host {
...
`}}},argTypes:{compHeight:{control:"text",description:"Height of the component",table:{defaultValue:{summary:"fit-content"},category:"Component"}},compWidth:{control:"text",description:"Width of the component",table:{defaultValue:{summary:"200px"},category:"Component"}},userSelect:{control:"text",description:"User select behavior",table:{defaultValue:{summary:"none"},category:"Component"}},textColor:{control:"color",description:"Text color",table:{defaultValue:{summary:"black"},category:"Text"}},textJustify:{control:"text",description:"Justify text",table:{defaultValue:{summary:"start"},category:"Text"}},textAlign:{control:"text",description:"Align text",table:{defaultValue:{summary:"center"},category:"Text"}},textShadow:{control:"text",description:"Text shadow",table:{defaultValue:{summary:"none"},category:"Text"}},textFontSize:{control:"text",description:"Font size",table:{defaultValue:{summary:"16px"},category:"Text"}},textFontWeight:{control:"text",description:"Font weight",table:{defaultValue:{summary:"normal"},category:"Text"}},textFontFamily:{control:"text",description:"Font family",table:{defaultValue:{summary:"'Helvetica', 'Arial', sans-serif"},category:"Text"}},textOverflow:{control:"text",description:"Text overflow style",table:{defaultValue:{summary:"ellipsis"},category:"Text"}},text:{control:"text",description:"Text content",table:{defaultValue:{summary:"Non-scrollable text example."},category:"Text"}}}},s=t=>p`
  <non-scrollable-text
